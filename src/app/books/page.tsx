  ...
  return (
    <div className="bg-white text-[#111418] antialiased">
      <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden">
        {/* TopNavBar */}
        <header className="sticky top-0 z-50 flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#f0f2f4] bg-white px-4 py-3 md:px-10">
          <div className="flex items-center gap-4 md:gap-8">
            <div className="flex items-center gap-4 text-[#111418]">
              <div className="size-8 md:size-10 flex items-center justify-center text-primary">
                <svg
              ...
              <h2 className="hidden text-xl font-bold leading-tight tracking-[-0.015em] text-[#111418] md:block">
                BookNow
              </h2>
            </div>
            <nav className="hidden items-center gap-6 lg:flex">
              <Link
                className="text-sm font-medium leading-normal text-[#111418] hover:text-primary"
                href="#"
              >
                Home
              </Link>
          ...
          <div className="flex flex-1 justify-end gap-4 md:gap-8">
            <label className="hidden flex-col min-w-40 !h-10 max-w-64 md:flex">
              <div className="flex w-full flex-1 items-stretch rounded-lg h-full bg-[#f0f2f4]">
                <div className="text-[#617589] flex items-center justify-center pl-4 rounded-l-lg border-r-0">
                  <span className="material-symbols-outlined text-[20px]">search</span>
                </div>
                <input
                  className="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-[#111418] focus:outline-0 focus:ring-0 border-none bg-transparent focus:border-none h-full placeholder:text-[#617589] px-4 rounded-l-none border-l-0 pl-2 text-sm font-normal leading-normal"
                  placeholder="Search books, authors..."
                />
              </div>
            </label>
            <div className="flex gap-2">
              <button className="flex h-10 w-10 cursor-pointer items-center justify-center rounded-full bg-[#f0f2f4] text-[#111418] hover:bg-gray-200 md:w-auto md:rounded-lg md:px-4">
                <span className="material-symbols-outlined text-[20px]">shopping_cart</span>
                <span className="hidden text-sm font-bold md:block">Cart (2)</span>
              </button>
              <button className="flex h-10 w-10 cursor-pointer items-center justify-center rounded-full bg-[#f0f2f4] text-[#111418] hover:bg-gray-200 md:w-auto md:rounded-lg md:px-4">
                <span className="material-symbols-outlined text-[20px]">person</span>
                <span className="hidden text-sm font-bold md:block">Account</span>
              </button>
            </div>
          </div>
        </header>
